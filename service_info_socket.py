...
def service_check(target_server_ip, port, task_id):
    # 准备ip和端口
    ...
    send_data = '{"typeCode":%d,"basename":"%s","finish_time":"%s","scanid":"%s","data": %s}' % (Type.SERVICE_INFO, board_id, time, task_id, data)
